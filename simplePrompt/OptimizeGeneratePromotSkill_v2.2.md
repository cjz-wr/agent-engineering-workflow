# Project Bootstrap & Development Workflow Skill

> 版本：v2.2
>
> 定位：新项目开发 Skill，同时作为 **Base Engineering Protocol**，被 Feature Change Workflow Skill 继承。基于 `readme.md` 需求，从零搭建项目并完成增量开发。
>
